...
# Leer el estado del archivo de control
...
def main():
    ...
    for perfume_url in perfume_links:
        control_command = read_control_file()
        if control_command == "PAUSE":
            print("Ejecución pausada. Cambia el estado a 'RUN' en control.txt para continuar.")
        ...
        # Guardar los datos temporalmente en cada iteración para evitar pérdida de datos
