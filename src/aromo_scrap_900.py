...
# Leer los enlaces desde el archivo perfume_links02rest.txt
with open('perfume_links02rest.txt', 'r', encoding='utf-8') as file:
    ...
    with open('perfumes_test.csv', mode='a', newline='', encoding='utf-8') as file:
        ...
        for link in remaining_links:
            ...
            try:
                ...
                # Pausar después de 900 iteraciones
                if iteration_counter % 900 == 0:
                    print("Esperando 5 minutos para evitar ser bloqueado...")
